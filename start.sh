...
function rebuild_db {
	...
	rm -rf "${BASE_DIR}/mysite/ask/migrations/0001_initial"
	ls "${BASE_DIR}/mysite/ask/migrations/"
	logging "migrate"
	python "${BASE_DIR}/mysite/manage.py" "migrate"
	logging "makemigrations" "ask"
	python "${BASE_DIR}/mysite/manage.py" "makemigrations" "ask"
	logging "migrate"
	python "${BASE_DIR}/mysite/manage.py" "migrate"
	logging "initdb.py"
